...
public class TFileAndStart implements org.apache.thrift.TBase<TFileAndStart, TFileAndStart._Fields>, java.io.Serializable, Cloneable, Comparable<TFileAndStart> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TFileAndStart");
  ...
  static {
    schemes.put(StandardScheme.class, new TFileAndStartStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TFileAndStartTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TFileAndStart.class, metaDataMap);
  }

  public TFileAndStart() {
  }
   ...
   */
  public TFileAndStart(TFileAndStart other) {
  ...
  public TFileAndStart deepCopy() {
    return new TFileAndStart(this);
  }
  ...
  public TFileAndStart setFile(byte[] file) {
    this.file = file == null ? (ByteBuffer)null : ByteBuffer.wrap(Arrays.copyOf(file, file.length));
    return this;
  }

  public TFileAndStart setFile(ByteBuffer file) {
    this.file = org.apache.thrift.TBaseHelper.copyBinary(file);
    return this;
  }
  ...
  public TFileAndStart setStart(long start) {
    this.start = start;
    setStartIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TFileAndStart)
      return this.equals((TFileAndStart)that);
    return false;
  }

  public boolean equals(TFileAndStart that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TFileAndStart other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TFileAndStart(");
    boolean first = true;
  ...
  private static class TFileAndStartStandardSchemeFactory implements SchemeFactory {
    public TFileAndStartStandardScheme getScheme() {
      return new TFileAndStartStandardScheme();
    }
  }

  private static class TFileAndStartStandardScheme extends StandardScheme<TFileAndStart> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TFileAndStart struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TFileAndStart struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TFileAndStartTupleSchemeFactory implements SchemeFactory {
    public TFileAndStartTupleScheme getScheme() {
      return new TFileAndStartTupleScheme();
    }
  }

  private static class TFileAndStartTupleScheme extends TupleScheme<TFileAndStart> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TFileAndStart struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TFileAndStart struct) throws org.apache.thrift.TException {
